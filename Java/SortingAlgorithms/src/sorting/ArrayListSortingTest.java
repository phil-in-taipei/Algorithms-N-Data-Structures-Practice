...
class ArrayListSortingTest {
    ...
    void mergeSortResult() {
        assertEquals(
                this.test1.mergeSortResult().toString(),
                "[0, 19, 40, 230, 931, 1222, 8998, 89899, 398391]"
        );
        assertEquals(this.test2.mergeSortResult().toString(), "[1, 2, 3, 5, 8]");
        assertEquals(this.test3.mergeSortResult().toString(), "[1, 2, 2, 3, 4, 4]");
    }
    ...
    void selectionSort() {
        assertEquals(
                this.test1.selectionSort().toString(),
                "[0, 19, 40, 230, 931, 1222, 8998, 89899, 398391]"
        );
        assertEquals(this.test2.selectionSort().toString(), "[1, 2, 3, 5, 8]");
        assertEquals(this.test3.selectionSort().toString(), "[1, 2, 2, 3, 4, 4]");
    }
}